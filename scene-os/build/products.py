...
def main():
    ...
    STORE = 'https://www.skool.com/thesceneai/about'
    jobs = [
        ...
        ('STARTER', starter_pages(members=True), LIME,
         {'kicker': 'CAST YOUR LEAD', 'title': 'YOUR FIRST AI CHARACTER',
          ...
          'banner_url': 'https://www.skool.com/thesceneai/classroom'},
